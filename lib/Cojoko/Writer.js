define(['lodash', 'Cojoko/debug', 'AMD/Definition', 'AMD/Dependency', 'AMD/Generator', 'escodegen'], function (_, debug, Definition, Dependency, AMDGenerator, escodegen) {
  ...
  return function () {
    ...
    this.write = function (cojokoClass, options) {
      ...
      var amd = this.initModuleDefinition(cojokoClass, options);
    ...
    this.initModuleDefinition = function (cojokoClass, options) {
      ...
      var globalObject = {}; // TODO write it
