  ...
  return function() {
    ...
    this.compileInitValueExpression = function(value, property) {
      ...
      if (_.isPlainObject(value) && _.isEmpty(value)) {
        ...
        throw "The init value in property '"+property.name+"' from class '"+className+"' cannot be compiled - it is too complex. Remove the init value from property and set it in the init() function of the class.";
      }
    };
