define(['qunit-assert', 'test-setup', 'Cojoko', 'text!test-files/Cojoko/HTTPMessage.cojoko.js','test-files/Joose/HTTPMessage'], function(t, testSetup, Cojoko, HTTPMessageCojokoCode) {
